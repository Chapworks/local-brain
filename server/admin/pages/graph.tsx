...
export const GraphPage: FC<Props> = ({ user, isSuperuser, notifications, version, graphData }) => (
  <Layout title="Graph" user={user} isSuperuser={isSuperuser} notifications={notifications} version={version}>
