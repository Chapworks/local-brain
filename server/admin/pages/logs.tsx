...
export const LogsPage: FC<Props> = ({ user, isSuperuser, notifications, version, service, logs, services }) => (
  <Layout title="Logs" user={user} isSuperuser={isSuperuser} notifications={notifications} version={version}>
